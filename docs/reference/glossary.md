...
이 문서는 프로젝트 특유의 용어 사전이에요. 검색 · 치환 · 문서 일관성을 위해 표기를 고정해요.
...
- **영문 유지**: AppKit · Provider · Riverpod · ADR · Port 같은 개념어는 영문으로 써요
- **한글 사용**: 솔로 · 파생 레포 · 비목표 · 앱 공장 같은 프로젝트 특유 용어는 한글로 써요
- **혼용 금지**: "Kit" 과 "키트" 를 동시에 쓰지 않아요. 본 프로젝트는 "Kit" 만 써요

---

## 관련 문서

- [`STYLE_GUIDE`](../STYLE_GUIDE.md) — §4 용어 **사용 규칙**(표기 고정·약어 풀어쓰기 등). 용어 **목록**은 이 문서가 단일 출처
